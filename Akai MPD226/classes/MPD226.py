...
class MPD226:
    ...
    pad_1 = Pad(1, 'pad', 36)  # C#2
    pad_2 = Pad(2, 'pad', 37)  # C2
    pad_3 = Pad(3, 'pad', 38)  # F#2
    pad_4 = Pad(4, 'pad', 39)  # A#5
    pad_5 = Pad(5, 'pad', 40)  # E2
    pad_6 = Pad(6, 'pad', 41)  # D2
    pad_7 = Pad(7, 'pad', 42)  # A#2
    pad_8 = Pad(8, 'pad', 43)  # G#2
    pad_9 = Pad(9, 'pad', 44)  # C3
    pad_10 = Pad(10, 'pad', 45)  # B2
    pad_11 = Pad(11, 'pad', 46)  # A2
    pad_12 = Pad(12, 'pad', 47)  # G2
    pad_13 = Pad(13, 'pad', 48)  # C#3
    pad_14 = Pad(14, 'pad', 49)  # G3
    pad_15 = Pad(15, 'pad', 50)  # D#3
    pad_16 = Pad(16, 'pad', 51)  # F3
